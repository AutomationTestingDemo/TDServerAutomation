...
public class StartAutomationSuiteFor3RI extends BaseClassTDS {
...
//		BaseClassTDS baseClass= new BaseClassTDS();
//		baseClass.initialiseReport(testContext);
		...
		Map<String, String> apiTestdata = testScenarioData.get("3RI_AReq_API");
...
//		System.out.println("================================================================");
		...
		System.out.println("Required replaced Json is ***:\n" + jsonRequest);
		...
		e.printStackTrace();	
		Assert.fail("App Flow:: ARes Validation Failed."+apiResponse);
		}
	}
